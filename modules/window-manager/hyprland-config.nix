  ...
  homeManager.modules.desktop =
    ...
    in
    {
      ...
      xdg.configFile."hypr/hyprland.lua".text = ''
        ...
        local systemMode = "system:${config.home.homeDirectory}/.config/hypr/scripts/rofi-system.sh"
        local menu = 'rofi -show drun -modi "drun,run,window,' .. systemMode .. '"'
        local controlCenter = 'rofi -show system -modi "' .. systemMode .. '"'
        local mainMod = "SUPER"
        ...
        hl.bind(mainMod .. " + F", hl.dsp.exec_cmd("fsearch"))
          ...
          text = ''
            ...
            if [ -n "$1" ]; then
              case "$1" in
                ...
                "Wi-Fi Quick Connect") pkill -x rofi 2>/dev/null; (networkmanager_dmenu) & ;;
